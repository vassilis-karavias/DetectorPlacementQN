...
def import_problem_detectors(node_file_path, edge_file_path, key_dict_path):
    key_dict_data = pd.read_csv(key_dict_path)
    ...
    for id in possible_ids:
        ...
        graphs[id] = graph
        key_dict_current = key_dict_data[key_dict_data["ID"] == id].drop(["ID"], axis =1)
